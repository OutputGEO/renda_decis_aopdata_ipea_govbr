...
map.getView().fit([-5216122.836379, -2725013.130257, -5157810.211604, -2683165.275028], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Distribuição de Renda em São Paulo</h2>';
        return titleElement;
    })(),
